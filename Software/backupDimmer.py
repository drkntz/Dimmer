...
def onZeroCross(channel):	# Interrupt handler for the positive-going zero crossing signal. Drives the triac.
	if(delay != MAXDELAY):
...
if __name__ == '__main__':
	GPIO.add_event_detect(ZCROSS, GPIO.RISING, callback=onZeroCross, bouncetime=3) # Setup for GPIO interrupt. Debounce is in milliseconds
	main()	
